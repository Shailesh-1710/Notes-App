  ...
  async function getNotes() {
    const fetcheddata = await toast.promise(
      axios.get("http://localhost:5000/"),
      {
        ...
        success: "Data Recieved and Updated 👌",
    ...
    <div className="grid place-items-center ">
      ...
      <div className="grid place-items-center pt-3 h-auto  rounded-2xl  ">
        ...
        {dataLoading && (
          <svg
            role="status"
            class="w-8 h-8 mr-2 m-3 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
            viewBox="0 0 100 101"
            fill="none"
            ...
            return (
              <div class="flex m-3 h-auto " key={element.Uuid}>
                <div class="block py-6 px-6 rounded-lg shadow-lg bg-white w-80">
                  ...
                  <button
                    type="button"
                    class="text-white bg-blue-700 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    onClick={() => <div></div>}
                  >
                    <FaEdit />
                    <h2>Edit Note</h2>
